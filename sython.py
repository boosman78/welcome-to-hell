...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id :
        order = await event.reply('Hi my Dev @M_i_X')
...
async def _(event):
        ...
        await sython.send_message('@zmmbot', 'جاري التجميع بواسطة | LU TM')
        channel_entity = await sython.get_entity(bot_username)
...
async def _(event):
        ...
        await sython.send_message('@xnsex21bot', 'جاري التجميع بواسطة | LU TM ')
        channel_entity = await sython.get_entity(bot_usernamee)
        ...
        for i in range(100):
            ...
            msgs = list.messages[0]
            if msgs.message.find('لا يوجد قنوات في الوقت الحالي , قم يتجميع النقاط بطريقه مختلفه') != -1:
                await sython.send_message(event.chat_id, f"لايوجد قنوات  في البوت | LU TM")
                break
            url = msgs.reply_markup.rows[0].buttons[0].url
            try:
                try:
...
async def _(event):
      await event.reply("""Yeah I'm working~ @isRamy ~| 
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍
...
CH  : https://t.me/LUCITHON
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍"""
)

@sython.on(events.NewMessage(outgoing=True, pattern=".مطور"))
async def _(event):
      await event.reply("""LU OWNER : @isRamy"""
)
